...
var fitbitAccessToken;
 ...
 //http%3A%2F%2Fwww.howardshaw.info%2F

var redirectHttp = 'http%3A%2F%2F';
var redirectUrl = redirectHttp + 'localhost%3A8080%2Fjuced';
if (!window.location.hash) {
    window.location.replace('https://www.fitbit.com/oauth2/authorize?response_type=token&client_id=228DR5&redirect_uri=' + redirectUrl + '&scope=activity%20nutrition%20heartrate%20location%20nutrition%20profile%20settings%20sleep%20social%20weight');
} else
{
